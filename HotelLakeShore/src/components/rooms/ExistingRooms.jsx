...
const ExistingRooms = () => {
    ...
    const handleDelete = async(roomId) =>{
        try{
          ...
          if(result === null){
            setSuccessMessage(`Room with room id ${roomId} was deleted`)
            fetchRooms()
          }else{
            ...
            <>
               <section className='mt-5 mb-5 container'>
                  <div className='d-flex justify-content-between mb-3 mt-5'>
                              ...
                              <tr key = {room.id} className='text-center'>
                                  ...
                                  <td >
                                    ...
                                    <Link to = {`/edit-room/${room.id}`}> 
                                        <span className='btn btn-warning btn-small mx-auto'>
                                            <FaEdit/>
                                        Edit </span>
                                    </Link>
                                    <button className='btn btn-danger btn-small mx-auto' onClick ={()=>handleDelete(room.id)}>
                    ...
                    <RoomPaginator currentPage={currentPage} totalPages = {calculateTotalPage(filteredRooms,roomsPerPage,rooms)}
